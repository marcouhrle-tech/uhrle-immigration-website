...
const n = nextN();
await page.screenshot({ path: join(dir, `screenshot-${n}-pricing-full.png`), clip: { x: 0, y: box.y, width: 390, height: Math.min(box.height + 40, 900) } });
console.log(`Saved pricing full (${n})`);
